			...
			<div class="col s12 m4">
				...
				<div class="info-box habilidade z-depth-3">
					<div class="info-text">
						...
						<p>MySQL</p>
						<div class="skill-bar"><p class="center-align" style="width: 80%;">80%</p></div>
						<p>Java</p>
						<div class="skill-bar"><p class="center-align" style="width: 60%;">60%</p></div>
						<p>C, C++</p>
						<div class="skill-bar"><p class="center-align" style="width: 50%;">50%</p></div>
						<p>Git</p>
						<div class="skill-bar"><p class="center-align" style="width: 40%;">40%</p></div>
						<p>Wordpress</p>
						<div class="skill-bar"><p class="center-align" style="width: 70%;">70%</p></div>
						<p>CodeIgniter</p>
						<div class="skill-bar"><p class="center-align" style="width: 40%;">40%</p></div>
					</div>
				</div>
